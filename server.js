...
app.post('/search', (req, res) => {
    ...
    let movieUrl = `https://api.themoviedb.org/3/search/movie?query=${userMovieTitle}&api_key=cbb62466eec5c24338dc17a91eb02bc4`;
    let genresUrl = 'https://api.themoviedb.org/3/genre/movie/list?api_key=cbb62466eec5c24338dc17a91eb02bc4&language=en-US';
